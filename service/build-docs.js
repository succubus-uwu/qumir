  ...
  return `
    <nav class="docs-page-sidebar" id="docs-sidebar">
      ...
      <div id="docs-nav-docs"${isArchMode ? ' style="display:none"' : ''}>
        ...
        <a href="${prefix}keyboard.html" class="${active === 'keyboard.md' ? 'active' : ''}">Исполнитель Клавиатура</a>
...
function buildOne(mdFile, { srcDir = DOCS_SRC, mode = 'docs' } = {}) {
  ...
  const titles = {
    ...
    'keyboard.md': 'Документация — Qumir (Исполнитель Клавиатура)',
  ...
  const descriptions = {
    'index.md': 'Полная документация по языку программирования КуМир: синтаксис, компилятор, интерпретатор, исполнители Черепаха, Чертежник, Робот и Клавиатура. Примеры программ и руководства.',
    ...
    'keyboard.md': 'Исполнитель Клавиатура в КуМир: чтение нажатий клавиш, сканкоды, autorepeat и управление интерактивными программами.',
