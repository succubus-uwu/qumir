...
Эта страница перечисляет встроенные функции и процедуры Qumir, которые доступны без подключения исполнителей. Команды исполнителей описаны отдельно: [Черепаха](turtle.md), [Робот](robot.md), [Чертежник](drawer.md), [Рисователь](painter.md), [Клавиатура](keyboard.md). Модуль [Комплексные числа](complex.md) тоже имеет отдельную страницу.
